...
/* ═══════════════════════════════════════════════
   FALLBACK DATA
   Mirrors the design from the screenshots.
   Replace with real WP ACF field names.
═══════════════════════════════════════════════ */
const FALLBACK = {
  hero: {
    ...
    // cta_primary: { label: "Get Started",   url: "#contact" },
    // cta_secondary:{ label: "View Solutions", url: "#solutions" },
    bg_image:    "",
  },
  tagline: {
